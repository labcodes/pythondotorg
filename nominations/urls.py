...
urlpatterns = [
    ...
    path(
        "elections/<slug:election>/nominees/",
        views.NomineeList.as_view(),
        name="nominees_list",
    ),
    path(
        "elections/<slug:election>/nominees/<slug:slug>/",
    ...
    path(
        "<slug:election>/<int:pk>/accept/",
        views.NominationAccept.as_view(),
