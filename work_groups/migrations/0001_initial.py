    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'url',
                    models.URLField(help_text='Main URL for Group', blank=True),
                ),
                (
                    '_support_rendered',
                    models.TextField(editable=False),
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        related_name='work_groups_workgroup_creator',
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        related_name='work_groups_workgroup_modified',
                        to=settings.AUTH_USER_MODEL,
                        null=True,
                        on_delete=models.CASCADE,
                    ),
