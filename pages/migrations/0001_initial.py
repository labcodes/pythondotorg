    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'document',
                    models.FileField(upload_to='files/', max_length=500),
                ),
            ],
            options={},
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'image',
                    models.ImageField(
                        upload_to=pages.models.page_image_path,
                        max_length=400,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'description',
                    models.TextField(help_text='HTTP meta-description', blank=True),
                ),
                (
                    'path',
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                message='Please enter a valid URL segment, e.g. "foo" or "foo/bar". Only lowercase letters, numbers, hyphens and periods are allowed.',
                                regex=re.compile(
                ...
                (
                    'content_type',
                    models.CharField(max_length=150, default='text/html'),
                ),
                (
                    '_content_rendered',
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name='pages_page_modified',
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
