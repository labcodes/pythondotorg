            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="downloads_os_creator",
                        blank=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name="downloads_os_modified",
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_latest",
                    models.BooleanField(
                        help_text="Set this if this should be considered the latest release for the major version. Previous 'latest' versions will automatically have this flag turned off.",
                        db_index=True,
                ...
                (
                    "release_notes_url",
                    models.URLField(verbose_name="Release Notes URL", blank=True),
                ),
                (
                    "content",
                    markupfield.fields.MarkupField(default="", rendered_field=True),
                ),
                (
                    "content_markup_type",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name="downloads_release_creator",
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name="downloads_release_modified",
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_source",
                    models.BooleanField(
                        verbose_name="Is Source Distribution",
                        default=False,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name="downloads_releasefile_creator",
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        to=settings.AUTH_USER_MODEL,
                        related_name="downloads_releasefile_modified",
                        blank=True,
                        on_delete=models.CASCADE,
                    ),
                ),
