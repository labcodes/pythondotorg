    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_description_markup_type",
                    models.CharField(
                        max_length=30,
                        choices=[
                            ("", "--"),
                ...
                (
                    "location_slug",
                    models.SlugField(max_length=350, editable=False),
                ),
                (
                    "country_slug",
                    models.SlugField(max_length=100, editable=False),
                ),
                (
                    "description",
                    markupfield.fields.MarkupField(rendered_field=True, blank=True),
