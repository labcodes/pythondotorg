...
urlpatterns = [
    ...
    path(
        ...
        name='user_membership_create',
    ),
    path(
        'membership/edit/',
        views.MembershipUpdate.as_view(),
        name='user_membership_edit',
    ),
    re_path(
    ...
    path(
        'membership/thanks/',
        views.MembershipThanks.as_view(),
        name='user_membership_thanks',
    ),
    path(
        'membership/affirm/',
        views.MembershipVoteAffirm.as_view(),
        name='membership_affirm_vote',
    ),
    path(
        'membership/affirm/done/',
        views.MembershipVoteAffirmDone.as_view(),
        name='membership_affirm_vote_done',
    ),
    path(
        'nominations/',
        views.UserNominationsView.as_view(),
        name='user_nominations_view',
    ),
    path(
        'sponsorships/',
        views.UserSponsorshipsDashboard.as_view(),
        name='user_sponsorships_dashboard',
    ),
    path(
