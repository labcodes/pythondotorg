    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'bio',
                    markupfield.fields.MarkupField(blank=True, rendered_field=True),
                ),
                (
                    'bio_markup_type',
                    models.CharField(
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (0, 'Anyone can see my e-mail address'),
                            (
                                1,
                            ...
                            (
                                2,
                                'No one can ever see my e-mail address',
                            ),
                        ],
                        verbose_name='E-mail privacy',
                        default=2,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.NullBooleanField(
                        verbose_name='I agree to the PSF Code of Conduct'
                    ),
                ),
                (
                    'psf_announcements',
                    models.NullBooleanField(
                        verbose_name='I would like to receive occasional PSF email announcements'
                    ),
                ),
                (
                    'created',
