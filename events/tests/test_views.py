...
class EventsViewsTests(TestCase):
    ...
    def test_event_list(self):
        url = reverse(
            "events:event_list",
            kwargs={"calendar_slug": self.calendar.slug},
        )
        response = self.client.get(url)
        ...
        url = reverse(
            "events:event_list_past",
            kwargs={"calendar_slug": "unexisting"},
        )
        response = self.client.get(url)
    ...
    def test_event_list_category(self):
        category = EventCategory.objects.create(
            name="Sprints", slug="sprints", calendar=self.calendar
        )
    ...
    def test_event_list_location(self):
        venue = EventLocation.objects.create(name="PSF HQ", calendar=self.calendar)
        ...
        url = reverse(
            "events:eventlist_location",
            kwargs={"calendar_slug": self.calendar.slug, "pk": 1234},
        )
        response = self.client.get(url)
