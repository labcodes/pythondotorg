...
def migrate_old_content(apps, schema_editor):
    ...
    content = (
        ...
        '<p>For Python events near you, please have a look at the <a href="https://lmorillas.github.io/python_events/">'
    ...
    Box.objects.filter(label="events-subscriptions").update(content=content)
