...
class TemplateProcessorsTestCase(TestCase):
    ...
    def test_url_name(self):
        ...
        self.assertEqual(
            {"URL_NAMESPACE": "", "URL_NAME": "inner"},
            context_processors.url_name(request),
        )
    ...
    def test_blog_url(self):
        ...
        self.assertEqual(
            ...
            context_processors.blog_url(request),
        )
    ...
    def test_user_nav_bar_links_for_non_psf_members(self):
        ...
        expected_nav = {
            "account": {
                ...
                "urls": [
                    {
                        "url": reverse("users:user_detail", args=["foo"]),
                        "label": "View profile",
                    },
                    {
    ...
    def test_user_nav_bar_sponsorship_links(self):
        ...
        self.assertEqual(
            expected_section,
            context_processors.user_nav_bar_links(request)["USER_NAV_BAR"][
                "sponsorships"
            ],
        )
