...
urlpatterns = [
    ...
    path(
        "shell/",
        TemplateView.as_view(template_name="python/shell.html"),
        name="shell",
    ),
    ...
    path(
        "download/",
        RedirectView.as_view(url="https://www.python.org/downloads/", permanent=True),
    ),
    path(
        "download/source/",
    ...
    path(
        "doc/",
        views.DocumentationIndexView.as_view(),
        name="documentation",
    ),
    ...
    path(
        "inner/",
        TemplateView.as_view(template_name="python/inner.html"),
        name="inner",
    ),
    # other section landing pages
    path(
        "psf-landing/",
        TemplateView.as_view(template_name="psf/index.html"),
        name="psf-landing",
    ),
    path(
        "psf/sponsors/",
        TemplateView.as_view(template_name="psf/sponsors-list.html"),
        name="psf-sponsors",
    ),
    path(
        "docs-landing/",
    ...
    path(
        "pypl-landing/",
        TemplateView.as_view(template_name="pypl/index.html"),
        name="pypl-landing",
    ),
    path(
        "shop-landing/",
    ...
    path(
        "community/microbit/",
        TemplateView.as_view(template_name="community/microbit.html"),
        name="microbit",
    ),
    ...
    re_path(
        r"^m/(?P<url>.*)/$",
        views.MediaMigrationView.as_view(prefix="media"),
        name="media_migration_view",
    ),
]
