...
class SponsorshipQuerySet(QuerySet):
    ...
    def enabled(self):
        ...
        return (
            self.finalized().active_on_date(today).exclude(overlapped_by__isnull=False)
        )
    ...
    def with_logo_placement(self, logo_place=None, publisher=None):
        ...
        return self.filter(
            id__in=Subquery(benefit_qs.values_list('sponsorship_id', flat=True))
        )
...
class BenefitFeatureQuerySet(PolymorphicQuerySet):
    ...
    def from_sponsorship(self, sponsorship):
        return self.filter(sponsor_benefit__sponsorship=sponsorship).select_related(
            "sponsor_benefit__sponsorship"
        )
    ...
    def required_assets(self):
        ...
        return self.instance_of(*required_assets_classes).select_related(
            "sponsor_benefit__sponsorship"
        )
    ...
    def provided_assets(self):
        ...
        return self.instance_of(*provided_assets_classes).select_related(
            "sponsor_benefit__sponsorship"
        )
